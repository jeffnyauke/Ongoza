...
import com.piestack.ongoza.adapters.FilteredReportsSupportModeAdapter;
 ...
 */
@FragmentWithArgs
public class FilteredReportSupportModeFragment extends Fragment implements  SwipeRefreshLayout.OnRefreshListener, FilteredReportsSupportModeAdapter.MessageAdapterListener, SearchView.OnQueryTextListener{
    ...
    private FilteredReportsSupportModeAdapter mAdapter;
    ...
    public void init(){
        ...
        mAdapter = new FilteredReportsSupportModeAdapter(getActivity(), summaries, this);
        ...
        if(responses != null) {
            ...
            for(Report message : reports){
                ...
                if(summaries.isEmpty() || summaries == null){
                    ...
                    summary.setStheme(message.getModeName());
                    ...
                    for(Summary summary1: summaries){
                        Log.e("Loops", "count");
                        if(summary1.getStheme().equals(message.getModeName()) ) {
                            Log.e("Boolean", "false");
                            bool = false;
                        }
                    }
            ...
            for (Summary summary1 : summaries){
                ...
                for(Report report : reports){
                    if(summary1.getStheme().equals(report.getModeName())){
                ...
                summary1.setPartners(String.valueOf(spartner));
            }
            ...
            summary.setPartnerName(String.valueOf(partners));
