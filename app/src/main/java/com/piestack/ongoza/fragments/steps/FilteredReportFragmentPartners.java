 ...
 */
@FragmentWithArgs
public class FilteredReportFragmentPartners extends Fragment implements  SwipeRefreshLayout.OnRefreshListener, FilteredReportsAdapter.MessageAdapterListener, SearchView.OnQueryTextListener{
    ...
    private static final String TAG = "FilteredReportFragment";
