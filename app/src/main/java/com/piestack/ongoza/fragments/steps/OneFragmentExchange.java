...
@FragmentWithArgs
public class OneFragmentExchange extends Fragment {
    private  Unbinder unbinder;
    private String TAG = OneFragmentExchange.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view = inflater.inflate(R.layout.fragment_one, container, false);
        ...
        getActivity().setTitle("Create BDA");
    ...
    public void next(){
        ...
        report.setExchange(county_id != null);
        report.setCountyId(county_id == null ? MyApplication.getInstance().getPrefManager().getUser().getCounty_id().toString() : county_id);
