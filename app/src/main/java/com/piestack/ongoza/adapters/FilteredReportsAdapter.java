...
public class FilteredReportsAdapter extends RecyclerView.Adapter<FilteredReportsAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        public TextView stheme, hrs_bds, hrs_travel, partners;
        public LinearLayout messageContainer;

        public MyViewHolder(View view) {
            super(view);
            stheme = (TextView) view.findViewById(R.id.stheme);
            hrs_bds = (TextView) view.findViewById(R.id.hrs_bds);
            hrs_travel = (TextView) view.findViewById(R.id.hrs_travel);
            partners = (TextView) view.findViewById(R.id.partner);
    ...
    public FilteredReportsAdapter(Context mContext, List<Summary> messages, MessageAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.filtered_report_list_row, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.stheme.setText(StringUtils.isNullorEmpty(message.getStheme()) ? "": message.getStheme());
        holder.hrs_bds.setText(StringUtils.isNullorEmpty(message.getHrs_bds()) ?"": String.format("%.1f",Double.valueOf(message.getHrs_bds())));
        holder.hrs_travel.setText(StringUtils.isNullorEmpty(message.getHrs_travel()) ? "": String.format("%.1f",Double.valueOf(message.getHrs_travel())));
        holder.partners.setText(StringUtils.isNullorEmpty(message.getPartners()) ? "": String.format("%.0f",Double.valueOf(message.getPartners())));
