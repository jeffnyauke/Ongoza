...
public class FilteredReportsSupportModeAdapter extends RecyclerView.Adapter<FilteredReportsSupportModeAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        public TextView tvpartner, tvsm, tvhrsbds, tvhrstravel;
        public LinearLayout messageContainer;

        public MyViewHolder(View view) {
            super(view);
            tvpartner = (TextView) view.findViewById(R.id.tvpartner);
            tvsm = (TextView) view.findViewById(R.id.tvsm);
    ...
    public FilteredReportsSupportModeAdapter(Context mContext, List<Summary> messages, MessageAdapterListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.filtered_report_list_row_support_mode, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        // displaying text view data
            ...
            holder.tvsm.setText(StringUtils.isNullorEmpty(message.getStheme()) ? "" : message.getStheme());
        ...
        holder.tvpartner.setText(StringUtils.isNullorEmpty(message.getPartners()) ? "": String.format("%.0f",Double.valueOf(message.getPartners())));
